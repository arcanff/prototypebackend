...
var createProduct = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
    var _req$body, nombre, producto_inicial, numero_pedido, cantidad, medida, estado, producto_final, fecha, result;
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          // Obtiene los datos del cuerpo de la solicitud (req.body)
          _req$body = req.body, nombre = _req$body.nombre, producto_inicial = _req$body.producto_inicial, numero_pedido = _req$body.numero_pedido, cantidad = _req$body.cantidad, medida = _req$body.medida, estado = _req$body.estado, producto_final = _req$body.producto_final, fecha = _req$body.fecha; // Realiza una consulta para insertar el producto en la base de datos
          _context.next = 4;
          return _db.pool.query("INSERT INTO pedido (nombre, producto_inicial, numero_pedido, cantidad, medida, estado, producto_final, fecha) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", [nombre, producto_inicial, numero_pedido, cantidad, medida, estado, producto_final, fecha]);
        case 4:
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _db.pool.query("SELECT * FROM pedido");
        case 3:
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 4;
          return _db.pool.query("SELECT nombre, producto_inicial, numero_pedido, cantidad, medida, estado, producto_final, fecha FROM pedido WHERE id = ?", [id]);
        case 4:
...
var updateProduct = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    var id, _req$body2, nombre, producto_inicial, numero_pedido, cantidad, medida, estado, producto_final, fecha, result;
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _req$body2 = req.body, nombre = _req$body2.nombre, producto_inicial = _req$body2.producto_inicial, numero_pedido = _req$body2.numero_pedido, cantidad = _req$body2.cantidad, medida = _req$body2.medida, estado = _req$body2.estado, producto_final = _req$body2.producto_final, fecha = _req$body2.fecha; // Realiza una consulta para actualizar el producto con el ID especificado
          _context5.next = 5;
          return _db.pool.query("UPDATE pedido SET nombre = ?, producto_inicial = ?, numero_pedido = ?, cantidad = ?, medida = ?, estado = ?, producto_final = ?, fecha = ? WHERE id = ?", [nombre, producto_inicial, numero_pedido, cantidad, medida, estado, producto_final, fecha, id]);
        case 5:
    ...
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          // Obtiene el ID del producto de los parámetros de la solicitud (req.params)
          id = req.params.id;
          console.log("Eliminando el producto con ID: ".concat(id));

          // Realiza una consulta para eliminar el producto con el ID 
          _context6.next = 5;
          return _db.pool.query("DELETE FROM pedido WHERE id = ?", [id]);
        case 5:
          result = _context6.sent;
          console.log("Resultado de la eliminaci\xF3n:", result); // Agrega un registro de depuración aquí
